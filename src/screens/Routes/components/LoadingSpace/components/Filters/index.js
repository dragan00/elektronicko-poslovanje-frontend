...
// UI
import { Row, Col, Space, Checkbox, Form, Select, message } from "antd";
...
import PlaceAddForm from "../../../Cargo/components/Filters/PlaceAddForm";
...
const Filters = ({
  ...
  const [reRender, set_reRedner] = useState(0);
                ...
                >
                  ...
                  >
                    <Col lg={24} xl={12}>
                      ...
                      {device === "desktop" && <CustomVerticalDevider />}
